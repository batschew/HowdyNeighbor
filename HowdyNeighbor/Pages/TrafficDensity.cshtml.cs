...
{
    public class TrafficDensityModel : BasePageModel
    {
        public TrafficDensityModel(ApplicationDbContext context, IAuthorizationService authorizationService, UserManager<IdentityUser> userManager) : base(context, authorizationService, userManager)
        {
        }
        ...
        public async Task<IActionResult> OnPostAsync(int id)
        {
            ...
            Context.Attach(SearchList).Property(list => list.TrafficImportance).IsModified = true;
