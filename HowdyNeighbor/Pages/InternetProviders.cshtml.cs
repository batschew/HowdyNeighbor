...
{
    public class InternetProvidersModel : BasePageModel
    {
        public InternetProvidersModel(ApplicationDbContext context, IAuthorizationService authorizationService, UserManager<IdentityUser> userManager) : base(context, authorizationService, userManager)
        {
        }
        ...
        public async Task<IActionResult> OnPostAsync(int id)
        {
            ...
            Context.Attach(SearchList).Property(list => list.InternetProvidersImportance).IsModified = true;
